...
namespace SistemaOS.Banco_Global
{
    internal class BancoGlobalStatico
    {
        ...
        // Carregar estrutura Garantia
        public static List<GarantiaEstrutura> listBancoGarantia = new List<GarantiaEstrutura>();

        public static void CarregarServicosAndamento()
        {
            if (isServicosAndamentoInicializada == false)
            {
                listBancoServicosAndamento.Add(new ServicosAdamentoEstrutura(1, 1, "Galaxy S20", "Display", "123r5", "Display não liga", "Cartão SD", DateTime.Now, 60, 20, 40, "Troca do display", 1));
                listBancoServicosAndamento.Add(new ServicosAdamentoEstrutura(2, 2, "Galaxy S10", "Display", "123sr5", "Display não liga", "Carregador", DateTime.Now, 70, 80, -10, "Troca do display", 0));
                listBancoServicosAndamento.Add(new ServicosAdamentoEstrutura(3, 3, "Iphone 8", "Display", "12a3r5", "Display não liga", "N/A", DateTime.Now, 80, 40, 40, "Troca do display", 1));
                listBancoServicosAndamento.Add(new ServicosAdamentoEstrutura(4, 4, "Moto G 9", "Display", "1243r5", "Display não liga", "Capa", DateTime.Now, 100, 50, 50, "Troca do display", 0));
                listBancoServicosAndamento.Add(new ServicosAdamentoEstrutura(5, 5, "Xiaomi Redminote 8 pro", "Display", "12a3r5", "Display não liga", "N/A", DateTime.Now.Date, 110, 60, 50, "Troca do display", 1));
