...
namespace SistemaOS.Banco_Global
{
    internal class BancoGlobalStatico
    {
        ...
        public static List<ClienteEstrutura> bancoCliente = new List<ClienteEstrutura>();
        ...
        public static void carregarClientes()
        {
            ...
            {
                bancoCliente.Add(new ClienteEstrutura(1, "Rafael", "055.955.251-00", "(71)99177-3340", "(71)99177-3350"));
                bancoCliente.Add(new ClienteEstrutura(2, "Israel", "055.955.251-01", "(71)99177-3341", "(71)99177-3351"));
                bancoCliente.Add(new ClienteEstrutura(3, "Adriano", "055.955.251-02", "(71)99177-3342", "(71)99177-3352"));
                bancoCliente.Add(new ClienteEstrutura(4, "Robinho", "055.955.251-03", "(71)99177-3343", "(71)99177-3353"));
                bancoCliente.Add(new ClienteEstrutura(5, "Thiago", "055.955.251-04", "(71)99177-3344", "(71)99177-3354"));
